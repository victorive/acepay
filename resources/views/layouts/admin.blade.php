            ...
            <div class="flex flex-wrap mx-auto px-6 py-2 w-full justify-between items-center bg-white text-black border-b border-gray-200">
                ...
                <div class="hidden w-full md:flex md:items-center md:w-auto" id="menu">
                    <ul class="pt-4 md:pt-0 md:flex md:justify-between">
                        <li><a href="{{ route('view-users') }}" class="md:px-4 py-1 block">Users</a></li>
                ...
                <div>
                    ...
                    <div id="profile-menu" class="absolute bg-white hidden flex-col rounded top-0 right-0 bottom-auto left-auto m-0 -translate-x-[60px] translate-y-[50px] border border-gray-200 w-40 p-2 z-10 ">
                        ...
                        <a href="{{ route('admin-profile') }}" class="w-full relative flex items-center font-medium text-sm px-1 py-2 rounded hover:bg-[#e3f5e9]">Profile</a>
                        <a href="{{ route('admin-settings') }}" class="w-full relative flex items-center font-medium text-sm px-1 py-2 rounded hover:bg-[#e3f5e9]">Settings</a>
                        <a href="{{ route('admin-settings') }}" class="w-full relative flex items-center font-medium text-sm px-1 py-2 rounded hover:bg-[#e3f5e9]">Logout</a>
                    </div>
                </div>
            </div>
        </header>
