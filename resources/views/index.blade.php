...
<section class="px-4 py-10 min-h-screen">
    <div class="grid w-full grid-cols-1 md:grid-cols-12 gap-0 mx-auto lg:grid-cols-11 lg:gap-24 xl:w-11/12">
        <div class="col-auto text-center md:col-span-7 lg:text-left self-center">
            <h1 class="text-3xl font-bold md:text-3xl leading-tight md:leading-none tracking-tight md:tracking-normal mb-5">Make payments online, in-person & everywhere seamlessly.</h1>
