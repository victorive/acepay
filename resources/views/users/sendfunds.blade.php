<div class="mx-auto space-y-2 px-6 py-4 bg-white rounded-lg items-center my-12 xl:w-8/12" id="first-option">
    <form class="space-y-4">
        ...
        <label class="block">Leave a note (optional)</label>
        <input class="block w-full border border-gray-300 rounded-md py-1 px-2" type="text" placeholder="Note">
